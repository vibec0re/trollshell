...
pub use wire::{
    ...
    MAX_BODY_TEXT_BYTES, MAX_DISPLAY_TEXT_BYTES, MAX_SHADER_DATA_BYTES, MAX_SHADER_SOURCE_BYTES,
    Node, NodeId, SCROLLED_VOCAB, SHADER_VOCAB, ShaderData, SliderFloats, sane_fraction,
    sane_slider_floats,
};
